...
int main()
{
	Mat image = imread("../1216/lena.bmp", 0);
	...
	affine_transform(image, dst1, aff_map, image_size());
	affine_transform(image, dst2, rot_map, image_size());

	warpAffine(image, dst3, add_map, image.size(), INTER_LINEAR);
